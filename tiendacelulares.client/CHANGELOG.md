...
- Create Angular project with ng: `ng new tiendacelulares.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`tiendacelulares.client.esproj`).
